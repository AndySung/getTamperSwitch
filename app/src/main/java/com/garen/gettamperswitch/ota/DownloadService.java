...
import com.garen.gettamperswitch.MainActivity;
...
public class DownloadService extends Service {
    ...
    public DownloadListener listener=new DownloadListener() {
        ...
        public void onSuccess() {
            ...
            Intent intent = new Intent("com.soft.ota.broadcast");
            intent.putExtra("message","ota_download_success");    //发送文件下载成功的广播
        ...
        public void onFailed() {
            ...
            Intent intent = new Intent("com.soft.ota.broadcast");
            intent.putExtra("message","ota_download_failed");    //发送文件下载失败的广播
            sendBroadcast(intent);
        }
    ...
    public class DownloadBinder extends Binder{
        ...
        public void  startDownload(String url){
           if(downloadTask==null){
               ...
               Intent intent = new Intent("com.soft.ota.broadcast");
               intent.putExtra("message","ota_downloading");    //发送文件下载成功的广播
               sendBroadcast(intent);
           }
        }
        ...
        public void cancelDownload(){
            if(downloadTask!=null){
                ...
                if(downloadUrl!=null){
                    ...
                    String directory = MainActivity.HR40_OTA_PACKET_DIR;
