...
public class Constants {
    public static final int HTTP_PORT = 22333;
    ...
    public static final File DIR = new File("/sdcard/Download/");
    public static final String DIR_ROOT = "/data/media/0/Download/";
    //public static final File DIR = new File("/storage/emulated/0/Download/");
